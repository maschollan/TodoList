...
import com.kelompok4.todolist.databinding.ActivitySplashScreenBinding
...
class SplashScreenActivity : AppCompatActivity() {
     ...
     */
    private val changeActivity = View.OnTouchListener { view, motionEvent ->
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.dummyButton.setOnTouchListener(changeActivity)
    }
